            ...
            <aside class="tui-rail" x-bind:class="{ open: pinned || hover, unpinned: ! pinned }"
                ...
                <div class="tui-rail-foot">
                    ...
                    <button type="button" class="tui-rail-item tui-theme-toggle" title="Toggle theme"
                            x-on:click="const d=document.documentElement.classList.toggle('dark');localStorage.setItem('tui-theme',d?'dark':'light');window.dispatchEvent(new Event('telemetry-ui:theme-changed'))">
