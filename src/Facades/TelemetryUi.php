 ...
 * @method static \Cbox\TelemetryUi\TelemetryUiManager dimension(string $key, ?string $label = null, ?string $group = null, \Closure|string|null $link = null, ?string $entity = null, ?string $scope = null, ?list<string> $signals = null, ?string $format = null, ?string $plural = null)
